...
class Studscore_model extends CI_Model
{
    ...
    public function viewdropdownguru($a){
        $this->db->select('*');
       $this->db->from('subject');
       $this->db->where('id_teacher', $a);
       $query = $this->db->get();
       return $query->result();
    }
    ...
    public function getListdrd($a)
    {
       $this->db->select('*');
       $this->db->from('penilaian');
       $this->db->where('id_user', $a);
       $this->db->group_by('mata_kuliah');
       $query = $this->db->get();
       return $query->result();
    }
